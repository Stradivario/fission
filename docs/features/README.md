...
|------|------|-------|---------|--------|
| 2026-06-03 | Feature | Demand-driven builder concurrency (on-demand builder pods, one per build) | [builder-concurrency.md](builder-concurrency.md) | Implemented; build/unit verified. Live e2e pending. |
